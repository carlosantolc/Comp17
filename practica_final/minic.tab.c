...
#line 81 "minic.tab.c" /* yacc.c:339  */
...
#line 201 "minic.tab.c" /* yacc.c:358  */
...
{
       0,    43,    43,    46,    47,    48,    50,    53,    54,    57,
      58,    61,    62,    65,    66,    69,    70,    73,    76,    77,
      78,    79,    80,    81,    84,    85,    88,    91,    94,    95,
      98,   102,   106,   110,   114,   118,   129,   130,   134,   138,
     139,   142,   146,   150,   154,   158,   159,   160,   161,   162
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "PRINT", "READ", "PYC", "COMMA", "PLUSOP", "MINUSOP", "MULTOP",
  "DIVOP", "ASIGN", "PARI", "PARD", "LLAVEI", "LLAVED", "BOOL", "TRUE",
  "FALSE", "FLOAT", "LESS", "LESSEQ", "GREATER", "GREATEREQ", "EQ",
  "NOTEQ", "AND", "OR", "NOT", "NUM", "ID", "STRING", "DECIMAL", "UMENOS",
  "NOELSE", "$accept", "program", "declarations", "identifier_list",
  "asig", "identifier_list_float", "asig_float", "statement_list",
  "statement", "print_list", "print_item", "read_list",
  "expression_comparacion", "expression", YY_NULLPTR
};
#endif
...
{
       5,    -9,    15,    14,   -75,    16,    32,   -75,     1,     3,
       3,    27,     4,    33,    -8,   -75,     8,    50,    11,   -75,
      55,    58,    56,    44,   -75,   -75,    78,   -75,    61,   -75,
       3,   -75,    61,   -75,    27,    48,    48,    61,    61,   -75,
     -75,   -75,   -75,    19,   -75,   120,   -75,    30,    28,    61,
     120,   -75,   120,   -75,    48,   -75,   -75,    48,    79,    94,
      92,   -75,   113,   -75,    56,    61,    61,    61,    61,   -75,
      76,   -75,    74,   100,    87,   -75,    45,    61,    61,    61,
      61,    61,    61,    45,   -75,   -75,    62,    62,   -75,   -75,
     -75,   -75,    72,   123,   120,   120,   120,   120,   120,   120,
     -75,   119,   121,    45,    48,    48,   -75,   112,   122,   -75,
     -75
};
...
{
       0,     0,     0,     0,     1,     0,     0,     6,    16,     0,
       0,     0,     0,     9,     0,     7,     0,    13,     0,    11,
       0,     0,     0,     0,    16,     2,     0,    15,     0,     3,
       0,     4,     0,     5,     0,     0,     0,     0,     0,    48,
      47,    27,    49,     0,    24,    26,    28,     0,     0,     0,
      10,     8,    14,    12,     0,    39,    40,     0,     0,     0,
       0,    45,     0,    22,     0,     0,     0,     0,     0,    23,
       0,    18,     0,     0,     0,    36,     0,     0,     0,     0,
       0,     0,     0,     0,    46,    25,    41,    42,    43,    44,
      29,    17,     0,    20,    30,    32,    31,    33,    35,    34,
      21,     0,     0,     0,     0,     0,    19,     0,     0,    37,
      38
};
...
{
     -75,   -75,   -75,   128,   110,   -75,   108,   124,   -74,   -75,
      80,   -75,   -36,   -21
};
...
{
      60,    45,    93,    29,    30,     9,    10,    50,     1,   100,
      20,    52,    21,    22,    23,     4,    61,    62,    73,    31,
      30,    75,    33,    34,    24,    25,    11,     3,    72,   106,
      63,    64,     5,    74,    20,     6,    21,    22,    23,    13,
      26,    69,    70,    45,    86,    87,    88,    89,    24,    71,
      28,    20,     7,    21,    22,    23,    94,    95,    96,    97,
      98,    99,    37,    17,    26,    24,    54,    32,   107,   108,
      37,    55,    56,    35,    38,    37,    36,    67,    68,    38,
      46,    26,    57,    39,    40,    91,    42,    65,    66,    67,
      68,    39,    40,    41,    42,    49,    39,    40,    76,    42,
      65,    66,    67,    68,   101,   102,    84,    65,    66,    67,
      68,    83,    90,    77,    78,    79,    80,    81,    82,    92,
      77,    78,    79,    80,    81,    82,    65,    66,    67,    68,
     103,   109,    84,    65,    66,    67,    68,   104,    16,   105,
      51,   110,    53,     0,    85,     0,     0,     0,    48
};

static const yytype_int8 yycheck[] =
{
      36,    22,    76,    11,    12,     4,     5,    28,     3,    83,
       6,    32,     8,     9,    10,     0,    37,    38,    54,    11,
      12,    57,    11,    12,    20,    21,    25,    36,    49,   103,
      11,    12,    18,    54,     6,    19,     8,     9,    10,    36,
      36,    11,    12,    64,    65,    66,    67,    68,    20,    21,
      17,     6,    20,     8,     9,    10,    77,    78,    79,    80,
      81,    82,    14,    36,    36,    20,    18,    17,   104,   105,
      14,    23,    24,    18,    18,    14,    18,    15,    16,    18,
      36,    36,    34,    35,    36,    11,    38,    13,    14,    15,
      16,    35,    36,    37,    38,    17,    35,    36,    19,    38,
      13,    14,    15,    16,    32,    33,    19,    13,    14,    15,
      16,    19,    36,    26,    27,    28,    29,    30,    31,    19,
      26,    27,    28,    29,    30,    31,    13,    14,    15,    16,
       7,    19,    19,    13,    14,    15,    16,    18,    10,    18,
      30,    19,    34,    -1,    64,    -1,    -1,    -1,    24
};
...
{
       0,     3,    42,    36,     0,    18,    19,    20,    43,     4,
       5,    25,    48,    36,    44,    45,    44,    36,    46,    47,
       6,     8,     9,    10,    20,    21,    36,    49,    17,    11,
      12,    11,    17,    11,    12,    18,    18,    14,    18,    35,
      36,    37,    38,    50,    51,    54,    36,    52,    48,    17,
      54,    45,    54,    47,    18,    23,    24,    34,    53,    54,
      53,    54,    54,    11,    12,    13,    14,    15,    16,    11,
      12,    21,    54,    53,    54,    53,    19,    26,    27,    28,
      29,    30,    31,    19,    19,    51,    54,    54,    54,    54,
      36,    11,    19,    49,    54,    54,    54,    54,    54,    54,
      49,    32,    33,     7,    18,    18,    49,    53,    53,    19,
      19
};
...
#line 48 "minic.y" /* yacc.c:1646  */
    { printf("declarations -> declarations float identifier_list_float ;\n"); }
...
#line 54 "minic.y" /* yacc.c:1646  */
    { printf("identifier_list_float -> identifier_list_boolean , asig_float\n"); }
...
#line 65 "minic.y" /* yacc.c:1646  */
    { printf("asig_float -> ID\n"); }
#line 1511 "minic.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 66 "minic.y" /* yacc.c:1646  */
    { printf("asig_float -> ID = expression\n"); insertarVar(&lVar,(yyvsp[-2].str),(yyvsp[0].type),1); }
...
#line 77 "minic.y" /* yacc.c:1646  */
    { printf("statement -> if (expression_comparacion(%s)) statement else statement\n",tipos[(yyvsp[-4].type)]); }
#line 1547 "minic.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 78 "minic.y" /* yacc.c:1646  */
    { printf("statement -> if (expression_comparacion(%s)) statement\n",tipos[(yyvsp[-2].type)]); }
#line 1553 "minic.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 79 "minic.y" /* yacc.c:1646  */
    { printf("statement -> while (expression_comparacion) statement\n"); }
...
#line 98 "minic.y" /* yacc.c:1646  */
    { printf("expr_comp(%s) -> expr(%s) < expr(%s)\n",tipos[(yyval.type)],tipos[(yyvsp[-2].type)],tipos[(yyvsp[0].type)]);
...
#line 130 "minic.y" /* yacc.c:1646  */
    { printf("expr_comp -> expr_comp && expr_comp\n");
								if ((yyvsp[-5].type) != (yyvsp[-1].type)) {
									(yyval.type) = 3;
								} else { (yyval.type) = (yyvsp[-5].type);}}
...
#line 160 "minic.y" /* yacc.c:1646  */
    { printf("expr -> ID(%s)\n",(yyvsp[0].str)); (yyval.type) = consultarVar(lVar,(yyvsp[0].str)); }
#line 1751 "minic.tab.c" /* yacc.c:1646  */
    break;

  case 48:
#line 161 "minic.y" /* yacc.c:1646  */
    { (yyval.type) = 0; printf("expr(%s) -> NUM = %d\n",tipos[(yyval.type)],(yyvsp[0].num)); }
#line 1757 "minic.tab.c" /* yacc.c:1646  */
    break;

  case 49:
#line 162 "minic.y" /* yacc.c:1646  */
    { (yyval.type) = 1; printf("expr(%s) -> DECIMAL = %f\n",tipos[(yyval.type)],(yyvsp[0].dec)); }
